  ...
  return (
    <>
      ...
      >
        {summaryCards.map((card) => {
          ...
          return (
            <div
              key={card.label}
              className={`flex flex-col rounded-xl border p-5 transition-all hover:-translate-y-0.5 hover:shadow-lg ${
                card.highlight ? 'border-primary/30 bg-primary/10 hover:shadow-primary/10' : 'border-white/5 bg-card hover:border-primary/20 hover:shadow-primary/5'
              }`}
            >
      ...
      <motion.div
        ...
        className="mt-8 rounded-xl border border-white/5 bg-card p-6 transition-all hover:border-primary/20 hover:shadow-lg hover:shadow-primary/5"
      >
          ...
          {SEMESTER_DATA.map((s) => (
            <button
              ...
              className={`flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium transition-all ${
                s.result
                  ? 'bg-surface text-gray-300 hover:bg-primary/10 hover:text-primary-light hover:scale-105'
      ...
      >
        ...
        {timeline.map((item, idx) => (
          <motion.div
            ...
            className="relative rounded-xl border border-white/5 bg-card p-6 transition-all hover:border-primary/20 hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-0.5"
          >
            ...
            <div className="flex flex-wrap items-start justify-between gap-3 pl-4">
              <div className="flex-1">
                ...
                <p className="mt-0.5 text-sm text-gray-300">{item.institution}</p>
              ...
              <div className="flex shrink-0 flex-col items-end gap-1.5">
                {item.period && (
                  <span className="rounded-md bg-primary/10 px-3 py-1 text-xs font-medium text-primary-light">{item.period}</span>
                )}
